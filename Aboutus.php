...
<body onload="load()">
     <p>
      <div class="d-flex justify-content-center fs-1 fw-bold "> <div class="col-md-1"></div><h5 style="color: #f1c40f;;text-align: justify;font-size: 17px;"> 1. We offer our clients high quality bespoke design from concept development to technical projects and construction management. Our team has long-term experience in architecture, interior design and object design both in theory and practice.<br>
        2. We pay high attention to detail, artistry as well as the philosophy behind the forms we create and We strive to create | search | experiment with a better space for living.
    ...
    <div class="d-flex justify-content-center fs-1 fw-bold ">   <div class="col-md-3 abc"><img src="img/pngwing.png"class=""style="width: 210px;"> </div>   
       <video width="440" height="260" controls  autoplay>
        <source src="img/skynet.mp4" type="video/mp4">
